...
// vignette filter animation
void vignetteFilterAnimation(SDL_Renderer* renderer, SDL_Texture** spriteAnimation, 
int numSpriteFrames, int frameRate, int* quit, SDL_Texture** vignetteTexture, 
Uint32* startTime, int* currentFrame, int* windowWidth, int* windowHeight)
{
